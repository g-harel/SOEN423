...
/**
* EmployeeManagementSystem/LocationPOA.java .
...
public abstract class LocationPOA extends org.omg.PortableServer.Servant
 implements EmployeeManagementSystem.LocationOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // EmployeeManagementSystem/Location/_get_address
       {
         String $result = null;
         $result = this.address ();
         out = $rh.createReply();
       ...
       case 1:  // EmployeeManagementSystem/Location/createMRecord
       {
       ...
       case 2:  // EmployeeManagementSystem/Location/createERecord
       {
         String managerID = in.read_string ();
         String firstName = in.read_string ();
         String lastName = in.read_string ();
       ...
       case 3:  // EmployeeManagementSystem/Location/getRecordCounts
       {
         String managerID = in.read_string ();
         String $result = null;
       ...
       case 4:  // EmployeeManagementSystem/Location/editRecord
       {
         String managerID = in.read_string ();
       ...
       case 5:  // EmployeeManagementSystem/Location/transferRecord
       {
         String managerID = in.read_string ();
         String recordID = in.read_string ();
       ...
       case 6:  // EmployeeManagementSystem/Location/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
  ...
  private static String[] __ids = {
    "IDL:EmployeeManagementSystem/Location:1.0"};
